...
alongside skyroads/handrecovered_native and skyroads/bridge (pitfall #17):
``python tools/audit_layers.py skyroads/handrecovered skyroads/handrecovered_native skyroads/bridge``
