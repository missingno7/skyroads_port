...
AUTHORED_MODULES = (
    ...
    AuthoredModule("skyroads.handrecovered.lzs", RUNTIME,
                   AuthoredRole.FAITHFUL_FUNCTION,
                   "catalogued 1010:66E6 LZS decode semantics"),
    ...
    AuthoredModule("skyroads.handrecovered.relocate", RUNTIME,
                   AuthoredRole.FAITHFUL_FUNCTION,
                   "catalogued 1010:4052 relocation semantics"),
