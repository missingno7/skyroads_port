...
from skyroads.recovered.movement import _slong_div, _ulong_mul
from skyroads.recovered.player import RESUME_HEIGHT_GATE, is_landed_for_resume
...
@oracle_link(
    ...
    merge_target="skyroads.recovered_native.progression (future)",
)
