...
@oracle_link(
    ...
    merge_target="skyroads.recovered_native.player (future)",
)
...
@oracle_link(
    ...
    # (VM-less) frame steppers" entry and skyroads.recovered_native.gaps.VerticalVelocityGap,
    # which is how skyroads/recovered_native/loop.py guards this.
    status="ASM_MATCHED",
    merge_target="skyroads.recovered_native.player (future)",
)
