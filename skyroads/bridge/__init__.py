...
May know memory layout; holds no gameplay decisions
(docs/history/state_mirrors.md).
Audited alongside skyroads/handrecovered and skyroads/native for VM leakage
