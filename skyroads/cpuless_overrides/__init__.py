...
for that address in the standalone corpus. build_cpuless_standalone.py layers
these on top of skyroads/cpuless_standalone/ after generation, and the manifest
