...
WHAT IS SOURCE vs GENERATED
  ...
  * COMMITTED (the recorded no-CPU port surface): the recovered package
    ``skyroads/cpuless_standalone/``.  This script regenerates it IN PLACE,
  ...
  * IGNORED (regenerable scratch): the CPU-carrying hybrid adapters
    (``artifacts/cpuless_standalone_adapters/``) and the build intermediates.
