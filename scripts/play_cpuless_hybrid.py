...
Usage:
    python scripts/play_cpuless_hybrid.py                       # windowed
    python scripts/play_cpuless_hybrid.py --headless --frames 300
    python scripts/play_cpuless_hybrid.py --rebuild             # force a corpus rebuild
"""
