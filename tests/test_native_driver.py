"""Proof of "full vmless native gameplay": skyroads.handrecovered_native.loop.NativeGameplayDriver
...
from skyroads.handrecovered_native.loop import NativeGameplayDriver
...
def test_apply_level_init_zeroes_the_hud_gauge_caches() -> None:
    ...
    """
    from skyroads.handrecovered_native.loop import apply_level_init
