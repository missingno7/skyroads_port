...
skyroads.handrecovered_native.render_frame.composite_mode0 runs the full mode-0 pass --
...
from skyroads.handrecovered_native.render_frame import composite_mode0
